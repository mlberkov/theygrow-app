...
// transfer/config.js (DIA-DL-001). PPR-P2 changes the membership without
// changing the count: transfer/config.js is retired with the mechanism it
// described, and consent/config.js takes its place, so the four surfaces shipped
// under this mount are store/, export/, channel/ and consent/. The typed
