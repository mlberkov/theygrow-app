 ...
 * surfaces/import.js, deleted with the transfer offer at L3-P2, FIU-DL-002; the
 * mechanism behind it is gone too since PPR-P2.)
...
// DIA-P1 added the browser-to-native transfer seam through this same door, and
// PPR-P2 removed it. It was retired rather than kept dormant (owner decision
// 2026-08-22, FIU-DL-002 debt 18): its last product caller went with the offer
// surface at L3-P2, the one browser history it existed for has been carried
// across and confirmed on a device, and a mechanism whose only remaining callers
// are its own tests is one nobody notices breaking. The six names it hung here
// are gone with it; nothing else about this door changed.
